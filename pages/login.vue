...
<template>
	<div class="min-h-screen flex items-center justify-center bg-base-200 p-4 w-full">
		  ...
		  <div class="w-full lg:w-1/2">
		    <div class="card-body space-y-2 shadow-3xl">
			  ...
			  <button
				...
				:disabled="isLoading"
				class="btn w-full bg-base-200 hover:bg-base-300 normal-case text-base font-medium
